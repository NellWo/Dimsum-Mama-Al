...
function showOrderSummary() {
  ...
  // Save cart data to sessionStorage for the new page
  sessionStorage.setItem("finalOrderData", JSON.stringify(cart));

  // Tambahkan tanggal dan waktu saat ini ke sessionStorage
  sessionStorage.setItem("orderDateTime", getCurrentDateTime());
